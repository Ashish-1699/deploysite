param (
    ...
    [string]$Computer_Name = "172.30.35.191",
...
<#CREATING & ENTERING PS SESSION#>
    ...
    try{
        $password = ConvertTo-SecureString 'Koolsharma@1234' -AsPlainText -Force
    ...
    try {
        Copy-Item -path "netcoreapp3.1.zip" -Destination "C:\$Website_Name" -ToSession $Session 
